  ...
  <q-dialog maximized v-model="value">
    <div class="tw-bg-white tw-py-8 tw-px-5 tw-flex tw-flex-col tw-justify-center tw-items-center">
      <div class="tw-max-w-[420px] tw-text-center tw-w-full">
        ...
        <div class="tw-text-h1 tw-font-bold tw-mb-2">Обновите приложение</div>
        <div class="tw-text-t1 tw-mb-8">
          Для повышения стабильности, пожалуйста,<br/>обновите приложение до последней вверсии
        </div>
        <a
